...
%% Logfile Aggregator
load('articlebaz.com-Oct-2013Converted.mat')
U=UserAgent; R=Referrer; I=IP; H=HttpMethod; F=File; E=ErrorCode; DT=DateTime; DV=DataVolume;
load('articlebaz.com-Nov-2013Converted.mat')
DataVolume=[DV; DataVolume];
